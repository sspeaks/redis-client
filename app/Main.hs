...
printUsage = do
  ...
  putStrLn "  Pinned mode preserves opaque RESP3 values, including streamed value framing, without decoding them."
  putStrLn "  Malformed streamed RESP3 framing closes the pinned connection rather than resynchronizing within a payload."
