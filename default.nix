...
in
# Keep auxiliary derivations selectable with -A while making an unqualified
# nix-build produce the same canonical package as the flake default.
packages.fullPackageWithScripts // packages
