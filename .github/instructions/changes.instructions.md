...
Actions:
  - It's expected that you profile before you make changes and after you make changes with `cabal run --enable-profiling -- {flags}`. These 2 profiles should be compared and serious regressions must be addressed.
