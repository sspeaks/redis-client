...
Actions:
  ...
  - It's also expected that you run `cabal test` and `./rune2eTests.sh` whenever you're doen making changes. Note that `./rune2eTests.sh` requires `nix-build` and network access to download dependencies.
