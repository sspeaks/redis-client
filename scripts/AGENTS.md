...
- `test-compose-networking.sh` renders Compose JSON without starting containers and enforces loopback-only client publications, internal networks, unpublished cluster-bus ports, and the host-network profile gate.
